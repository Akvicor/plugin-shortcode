...
if (isMobile.any) {
    ...
    function handleTouchMove(evt) {
        ...
        if (pointer >= callAction.length) {
            displayed = true;
            var hide_and_seek_tags = document.getElementsByClassName('shortcode-hide-and-seek');
            for(var i = 0, l = hide_and_seek_tags.length; i < l; i++) hide_and_seek_tags[i].style.display = 'block';
            var hide_and_seek = document.getElementsByClassName('shortcode-hide-and-seek')[0];
        }
        xDown = null;
        yDown = null;
    };
